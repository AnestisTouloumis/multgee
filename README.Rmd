...
- `confint` for obtaining Wald confidence intervals for the regression parameters using the standard errors from the robust (`robust = TRUE`) or naive (`robust = FALSE`) covariance matrix. The default is the robust covariance matrix,
...
- `vcov` for obtaining the robust (`robust = TRUE`) or naive (`robust = FALSE`) covariance matrix of the estimated regression parameters.
