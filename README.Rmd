...
The **multgee** package provides a generalized estimating equations (GEE) solver for fitting marginal regression models with correlated nominal or ordinal multinomial responses based on a local odds ratios parameterization for the association structure [@Touloumis2013].
...
## Getting help
Details about the statistical methods implemented in **multgee** can be found in @Touloumis2013. A detailed description of **multgee** can be found in @Touloumis2015. An updated version of this paper also serves as a vignette for **multgee** which can be accessed by executing the following R commands: 
